...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            sub2api::sub2api_refresh_groups,
            ...
            usage_store::usage_upsert_catalog,
            usage_store::usage_set_active_group,
            usage_store::usage_active_multiplier,
            acp_consumer::acp_status,
            acp_consumer::acp_launch,
            acp_consumer::acp_prompt,
            acp_consumer::acp_set_model,
            ...
            acp_host::acp_host_clear_default_custom_model_context_limits,
            acp_host::acp_host_remove_legacy_provider_entries,
            acp_host::acp_host_ensure_custom_providers_image_capable,
            acp_host::acp_host_list_mcp_servers,
            acp_host::acp_host_add_mcp_server,
            acp_host::acp_host_remove_mcp_server,
            acp_host::acp_host_reconnect_mcp_server,
            acp_host::acp_host_ensure_mcp_environment,
            acp_host::acp_host_register_jupyter_mcp,
            ...
            git_snapshot::workspace_snapshot_tip,
            git_snapshot::preview_turn_undo_cmd,
            git_snapshot::undo_turn_cmd,
