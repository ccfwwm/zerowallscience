; ZeroWall Science — Simplified Chinese language overrides for NSIS installer.
; This file is loaded via tauri.conf.json `customLanguageFiles` and overrides
; the default Tauri language strings with product-specific messaging.
...
LangString dontUninstallDowngrade ${LANG_SIMPCHINESE} "不卸载（此安装程序已禁用降级而不卸载）"
...
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "系统已安装了较新版本的 ${PRODUCTNAME}！不建议安装旧版本。如确需安装，建议先卸载当前版本。请选择操作并点击下一步继续。"
LangString older ${LANG_SIMPCHINESE} "旧版"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统安装了 ${PRODUCTNAME} 的$R4版本。建议先卸载当前版本。请选择操作并点击下一步继续。"
LangString silentDowngrades ${LANG_SIMPCHINESE} "此安装程序已禁用降级，无法使用静默安装。请使用图形界面安装程序。$\n"
