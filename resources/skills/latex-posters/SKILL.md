...
2. Generate each element using figure-composer or Nano Banana Pro
...
For detailed guidance on creating schematics, refer to the **figure-composer** skill documentation.
...
**Recommended workflow**: Always use figure-composer and generate_image skills BEFORE creating the LaTeX poster to generate all visual elements.
