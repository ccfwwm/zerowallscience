...
- When the user attaches a supported document, use the parsed attachment preview and `read_uploaded_file` first. Do not require Python, uv, or an external MarkItDown installation for normal in-app uploads.
