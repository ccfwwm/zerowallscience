...
> **Security:** Never hardcode API keys in source code or commit them to version control. Configure the `ZOTERO_*` values in ZeroWall Settings > Credentials. Placeholder values like `ABC1234XYZ` below are illustrative.
...
Configure these names in ZeroWall Settings > Credentials:
