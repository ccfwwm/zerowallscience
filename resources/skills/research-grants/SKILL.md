...
license: MIT license
compatibility: Works in Agent Skills-compatible hosts. Grant-writing guidance needs no network; optional figures via the figure-composer skill require OPENROUTER_API_KEY and outbound API access.
metadata:
  version: "1.2"
...
- **Preferred:** Use the **figure-composer** skill (`--doc-type grant`) for AI-generated diagrams from a natural-language description
