"""
Kernel sidecar for the pdf-explore skill (zerowall edition).
...
in-kernel model-call bridge the zerowall host does not provide; they are
...
def pdf_resolve(path_or_id):
    ...
    zerowall — a UUID-shaped string that is not an existing path raises with
