...
- When the user attaches a supported document, use the parsed attachment preview and `read_uploaded_file` first. Do not require LibreOffice, Python, Tesseract, or an external LiteParse installation for normal in-app uploads.
