...
describe('ZeroWall Science system prompt', () => {
  it('describes the compact research capability surface without retired MCP names', () => {
    ...
    expect(SCIENCE_SYSTEM_PROMPT).toContain('do not wait for the user to name a skill')
    expect(SCIENCE_SYSTEM_PROMPT).toContain('deep-research')
    expect(SCIENCE_SYSTEM_PROMPT).toContain('academic-paper')
    expect(SCIENCE_SYSTEM_PROMPT).toContain('academic-paper-reviewer')
    expect(SCIENCE_SYSTEM_PROMPT).toContain('academic-pipeline')
    expect(SCIENCE_SYSTEM_PROMPT).toContain('/ars-* entries are user-invocable command shortcuts only')
