...
describe('ZeroWall Science system prompt', () => {
  it('describes the compact research capability surface without retired MCP names', () => {
    ...
    expect(SCIENCE_SYSTEM_PROMPT).toContain('Biomni is the remote Stanford Biomni biomedical research agent')
    expect(SCIENCE_SYSTEM_PROMPT).toContain('biomni_runtime')
    expect(SCIENCE_SYSTEM_PROMPT).toContain('biomni_catalog')
    expect(SCIENCE_SYSTEM_PROMPT).toContain('biomni_execute')
    expect(SCIENCE_SYSTEM_PROMPT).toContain('GTEx')
