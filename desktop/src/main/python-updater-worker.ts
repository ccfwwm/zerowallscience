...
process.on('message', async (message: any) => {
  ...
  try {
    const allowed = ['initialize', 'localStatus', 'pythonInfo', 'checkForUpdates', 'checkPythonPackageUpdates', 'installPythonPackage', 'updatePythonPackages', 'selectManual', 'rollback', 'previewPackages', 'applyPackagePlan']
