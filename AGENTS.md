...
Brand name: **ZeroWall Science** — "ZeroWall: Science Without Walls." It is a
local-first, model-agnostic AI research workbench for macOS, Windows, and Linux.
The bundle identifier is `com.zerowall.science`, and internal packages use
the `@zerowall/*` namespace.
