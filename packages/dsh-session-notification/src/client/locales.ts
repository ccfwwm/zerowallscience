...
export const zh = {
  ...
  'browser.title': '桌面通知',
  'browser.desc': '会话需要关注时弹出系统通知；点击通知打开对应对话。Windows 桌面版无需浏览器授权。',
  ...
  'test.notification.body': '桌面通知已发送，点击可返回当前对话。若未弹出，请检查 Windows 通知和勿扰设置。',
  'custom.replace': '更换',
...
export const en = {
  ...
  'browser.title': 'Desktop notifications',
  ...
  'test.notification.body': 'Desktop notification sent. Click to return to the conversation.',
