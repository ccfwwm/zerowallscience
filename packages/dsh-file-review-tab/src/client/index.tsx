...
export function apply(ctx: Context): void {
  ...
  const registerDeliverables = (): void => {
    ...
    // DSH alpha.5 ships the same `deliverables` Definition. The package patch
    // disables that entry in a clean composition, but desktop profiles may
    // already have mounted it before this plugin's patch is applied. Reuse
    // the resident definition rather than crashing the whole client on the
