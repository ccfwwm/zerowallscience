...
Markdown 预览中的本地图片以打开文件所在目录为基准。文件路径相对于工作区时，先与会话目录组合；客户端目录尚未就绪时保留相对路径，由后端从会话记录解析。图片通过 `/sidebar/file` 读取，预览不修改 Markdown 原文。
...
| [Lzh3070/dsh-file-review](https://github.com/Lzh3070/dsh-file-review) | <img alt="stars" src="https://img.shields.io/github/stars/Lzh3070/dsh-file-review?style=flat&color=4d6bfe" /> | 文件改动审查页：行级红绿 diff + 撤销 + chat 行深链 |
