...
export declare const RESIDENT_TOOLS: readonly ["capability_search", "capability_execute", "structured_output", "ask_user_question", "bash", "read", "write", "edit", "glob", "grep", "pwsh", "terminal_read", "terminal_send", "terminal_create", "terminal_wait_for", "todo_write"];
