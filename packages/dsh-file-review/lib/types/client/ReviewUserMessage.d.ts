...
export declare function ReviewUserMessage({ node, cwd, renderMessageImages, t, reviewT, sessionId, openAttachment, openParsedAttachment, copyAttachment, }: UserMessageProps): import("react").JSX.Element;
export {};
