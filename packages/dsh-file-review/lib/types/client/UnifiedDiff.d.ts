 ...
 */
export declare function UnifiedDiff({ layout, commentsActive, onCommentStart, diffs, contextLines, labels, className, showCopyButton, showFileHeaders, wordWrap, commentFor, onCommentChange, onCommentDelete, }: UnifiedDiffProps): import("react").JSX.Element | null;
