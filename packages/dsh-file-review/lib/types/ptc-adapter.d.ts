...
import type { PtcDispatchLog } from '@deepseek-ai/dsh-tools';
/**
 ...
 */
export declare function adaptPtcDispatchLog(ctx: Context, dispatch: PtcDispatchLog, next: () => Promise<ContentBlock[]>): Promise<ContentBlock[]>;
