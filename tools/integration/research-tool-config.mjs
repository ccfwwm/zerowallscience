...
const groups = [
  ...
  ['science-viewer', '科研资产查看、区域选择与可溯源序列分析', ['science_viewer', 'science_workbench']],
...
export const researchToolConfig = {
  ...
  skillBindings: [
    ...
    ['zerowall-geo', ['r-geo']], ['zerowall-nhanes', ['r-nhanes', 'research-study']], ['zerowall-rbioagent', ['biomni']],
    ...
    ['method-choice', ['research-study']],
      ['zerowall-research-evidence', ['r-compute', 'figureya', 'research-study']],
      ['zerowall-claim-audit', ['research-study', 'figureya']],
    ...['academic-pipeline', 'academic-paper', 'academic-paper-reviewer', 'deep-research'].map(skill => [skill, ['research-study', 'r-files', 'figureya']]),
    ['zerowall-data-contract', ['r-compute', 'r-files', 'r-nhanes', 'research-study']],
    ['zerowall-mr', ['r-compute', 'r-files', 'research-study']], ['zerowall-colocalization', ['r-compute', 'r-files', 'research-study']],
    ['zerowall-intervention-response', ['omicverse', 'r-compute']], ['zerowall-fiji', ['science-viewer', 'r-files', 'r-compute']],
    ...['western-blot', 'scratch-wound', 'colony-formation', 'bacterial-cfu', 'tube-formation'].map(name => [`zerowall-fiji-${name}`, ['science-viewer', 'r-files', 'r-compute']]),
    ['zerowall-molecule-docking', ['science-viewer', 'r-files', 'biomni']],
    ['zerowall-molecule-viewer', ['science-viewer']], ['zerowall-science-workbench', ['science-viewer']],
    ...
    ['zerowall-science-canvas', ['science-viewer', 'figureya', 'r-files']],
