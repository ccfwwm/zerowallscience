...
const base = {
  schema: 1, environmentId: 'claude-science-mcp', version: '2026.08.22.1', platform: 'win32', architecture: 'x64',
  ...
  python: { version: '3.12.0', relativeExecutable: 'bio-tools/python/python.exe' }, mcp: { bioToolsVersion: '0.0.37', ketcherChemistryVersion: '0.0.37', toolCount: 247, licenseToolCount: 14 }, source: { claudeScienceRuntime: '0.0.37-linux-x64', sourceHashes: {} }, signature: { algorithm: 'ed25519', keyId: 'test', value: '' },
} as const
